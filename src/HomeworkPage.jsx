...
export default function HomeworkPage({homework, updated}) {
  ...
  return <>
    ...
    <p className="homework-warning">已更正為 1A 版本，請以本頁更新後的作業表為準。</p>
    ...
    <section aria-labelledby="homework-reference">
      ...
      <a className="homework-image" href={imageUrl} target="_blank" rel="noopener noreferrer" aria-label="放大 Weekly Homework 原圖（另開分頁）"><img src={imageUrl} alt="1A 英文 Weekly Homework，8月31日至9月18日三週作業表" width="869" height="552" loading="lazy"/></a>
